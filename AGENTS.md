...
This is a *learning* project with a real deliverable. Nils is learning Svelte,
...
**Tier 1 — plumbing, free to use:** the toolchain itself (Vite, SvelteKit,
TypeScript, Prettier), and settled format parsers where the format is large and
boring: `mdsvex` for CommonMark/GFM, `shiki` for syntax highlighting.
...
may be adopted *after* the hand-written one works, with a stated reason and a
